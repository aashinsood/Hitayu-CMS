...
export default async function Contact() {
  ...
  const address = (settings?.contactAddress as string) || '4th Floor, Tech Tower, Baner Road, Pune – 411045'
  ...
  const infoItems = [
    ...
    },
    {
      ...
      title: 'Phone',
      lines: [phone, 'Emergency Support: 24 × 7 × 365'],
    },
    {
    ...
    },
    {
      ...
      lines: [hours, 'Emergency Support: 24 × 7 × 365'],
    },
  ]
        ...
        <div className="ht-con-g">
          ...
          <div>
            ...
            <p className="ht-sub ht-reveal">
              Tell us about your project. Our team will respond within 24 hours with a
              tailored proposal and consultation schedule.
            </p>
            ...
            <div className="ht-soc-row ht-reveal ht-d4">
              {socials.map((s, i) => (
                <a key={i} href={s.url} className="ht-soc" title={s.label} target="_blank" rel="noopener noreferrer">
                  <i className={s.icon} />
                </a>
              ))}
            </div>
