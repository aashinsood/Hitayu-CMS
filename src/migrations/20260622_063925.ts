...
END $$;
  ...
  DROP TABLE IF EXISTS "solutions_features" CASCADE;
  ...
  DROP TABLE IF EXISTS "about_page_features" CASCADE;
  ...
  DROP TABLE IF EXISTS "careers_page_benefits" CASCADE;
  ...
  DROP TABLE IF EXISTS "careers_page_traits" CASCADE;
  ...
  DROP TABLE IF EXISTS "careers_page" CASCADE;
  ...
  DROP TABLE IF EXISTS "partners_page_logos" CASCADE;
  ...
  DROP TABLE IF EXISTS "partners_page" CASCADE;
  ...
  DROP TABLE IF EXISTS "contact_page_locations" CASCADE;
  ...
  DROP TABLE IF EXISTS "site_settings_about_page_features" CASCADE;
  DROP TABLE IF EXISTS "site_settings_careers_page_benefits" CASCADE;
  DROP TABLE IF EXISTS "site_settings_careers_page_traits" CASCADE;
  DROP TABLE IF EXISTS "site_settings_contact_home_page_locations" CASCADE;
...
END $$;
  ...
  DROP INDEX IF EXISTS "site_settings_about_page_about_page_image_idx";
  DROP INDEX IF EXISTS "site_settings_about_page_about_page_agility_image_idx";
  DROP INDEX IF EXISTS "site_settings_careers_page_careers_page_image_idx";

  ALTER TABLE "services" ADD COLUMN IF NOT EXISTS "slug" varchar;
  ALTER TABLE "services" ADD COLUMN IF NOT EXISTS "category" "enum_services_category";
  UPDATE "services" SET "slug" = lower(regexp_replace(trim(coalesce("title", 'service')), '[^a-zA-Z0-9]+', '-', 'g')) || '-' || "id" WHERE "slug" IS NULL OR "slug" = '';
  UPDATE "services" SET "category" = 'Managed Services' WHERE "category" IS NULL;
  ...
  ALTER TABLE "services" ADD COLUMN IF NOT EXISTS "full_description" varchar;
...
END $$;
  ...
  CREATE INDEX IF NOT EXISTS "solutions_solution_image_idx" ON "solutions" USING btree ("solution_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "about_page_features_order_idx" ON "about_page_features" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "about_page_features_parent_id_idx" ON "about_page_features" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "about_page_image_idx" ON "about_page" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "about_page_agility_image_idx" ON "about_page" USING btree ("agility_image_id");
  CREATE INDEX IF NOT EXISTS "careers_page_benefits_order_idx" ON "careers_page_benefits" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "careers_page_benefits_parent_id_idx" ON "careers_page_benefits" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "careers_page_traits_order_idx" ON "careers_page_traits" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "careers_page_traits_parent_id_idx" ON "careers_page_traits" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "careers_page_image_idx" ON "careers_page" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "partners_page_logos_order_idx" ON "partners_page_logos" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "partners_page_logos_parent_id_idx" ON "partners_page_logos" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "partners_page_image_idx" ON "partners_page" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "contact_page_locations_order_idx" ON "contact_page_locations" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "contact_page_locations_parent_id_idx" ON "contact_page_locations" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "contact_page_locations_image_idx" ON "contact_page_locations" USING btree ("image_id");
  ...
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_eyebrow";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_title_line1";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_title_highlight";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_description";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_image_url";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_image_id";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_badge1_title";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_badge1_sub";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_badge2_title";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_badge2_sub";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_cta_text";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_cta_url";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_agility_title";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_agility_description";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_agility_image_url";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_agility_image_id";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_mvv_eyebrow";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_mvv_title_line1";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_mvv_title_highlight";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_mission";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_vision";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "about_page_values";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_eyebrow";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_title_line1";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_title_highlight";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_title_line2";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_description";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_image_url";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_image_id";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_benefits_eyebrow";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_benefits_title";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_traits_eyebrow";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_traits_title";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_cta_title";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_cta_description";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_cta_button_text";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_cta_button_url";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "careers_page_careers_email";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "contact_home_page_page_eyebrow";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "contact_home_page_page_title";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "contact_home_page_offices_eyebrow";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "contact_home_page_offices_title";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "contact_home_page_business_hours";
  ALTER TABLE "site_settings" DROP COLUMN IF EXISTS "contact_home_page_emergency_support";
`)
}
