...
END $$;;
  ...
  CREATE TABLE IF NOT EXISTS "site_settings_header_info_social_links" (
  ...
  CREATE TABLE IF NOT EXISTS "site_settings_hero_section_stats" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "site_settings_why_choose_section_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "site_settings_aws_section_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "site_settings_about_page_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "site_settings_contact_home_page_locations" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  ...
  ALTER TABLE "services" ADD COLUMN IF NOT EXISTS "icon_name" "enum_services_icon_name";
  ALTER TABLE "services" ADD COLUMN IF NOT EXISTS "image_url" varchar;
  ALTER TABLE "services" ADD COLUMN IF NOT EXISTS "service_image_id" integer;
  ALTER TABLE "services" ADD COLUMN IF NOT EXISTS "learn_more_url" varchar DEFAULT '#';
  ALTER TABLE "pricing_plans" ADD COLUMN IF NOT EXISTS "button_text" varchar DEFAULT 'Get Started';
  ALTER TABLE "pricing_plans" ADD COLUMN IF NOT EXISTS "button_url" varchar DEFAULT '#';
  ALTER TABLE "testimonials" ADD COLUMN IF NOT EXISTS "company" varchar;
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "logo_id" integer;
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "header_info_email" varchar DEFAULT 'info@hitayu.com';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "header_info_phone" varchar DEFAULT '+91 98765 43210';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "header_button_label" varchar DEFAULT 'Sign In';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "header_button_url" varchar DEFAULT '/signin';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "header_button_open_in_new_tab" boolean DEFAULT false;
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "hero_section_badge" varchar DEFAULT 'AWS Powered Cloud Hosting';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "hero_section_title" varchar DEFAULT 'Managed AWS Hosting
  Built For Speed,
  Security & Scale';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "hero_section_description" varchar DEFAULT 'Deploy your website on enterprise-grade AWS infrastructure with lightning-fast performance, daily backups and 24/7 expert support.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "hero_section_primary_button_text" varchar DEFAULT 'Get Started';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "hero_section_primary_button_url" varchar DEFAULT '#';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "hero_section_secondary_button_text" varchar DEFAULT 'View Plans';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "hero_section_secondary_button_url" varchar DEFAULT '#pricing';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "hero_section_hero_image_url" varchar DEFAULT 'https://wp.xpeedstudio.com/hostinza/wp-content/uploads/revslider/home-04/banner_image-41.png';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "hero_section_hero_image_id" integer;
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "stats_section_is_visible" boolean DEFAULT true;
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "why_choose_section_tag" varchar DEFAULT 'WHY CHOOSE HITAYU';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "why_choose_section_title" varchar DEFAULT 'Enterprise Grade
  Cloud Infrastructure';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "why_choose_section_description" varchar DEFAULT 'Power your applications with secure AWS hosting designed for businesses that demand reliability and performance.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "services_section_tag" varchar DEFAULT 'OUR SERVICES';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "services_section_title" varchar DEFAULT 'Hosting Solutions
  Built For Growth';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "services_section_description" varchar DEFAULT 'Powerful AWS-powered hosting services designed to keep your business online and growing.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "aws_section_tag" varchar DEFAULT 'AWS POWERED';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "aws_section_title" varchar DEFAULT 'Enterprise Cloud
  Infrastructure';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "aws_section_description" varchar DEFAULT 'Powered by Amazon Web Services, our cloud platform delivers unmatched reliability, scalability and security for businesses of all sizes.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "aws_section_button_text" varchar DEFAULT 'Explore AWS Hosting';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "aws_section_button_url" varchar DEFAULT '#';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "aws_section_image_url" varchar DEFAULT 'https://localhost.pixellyo.com/html/assets/img/about-img-7.png';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "aws_section_section_image_id" integer;
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "how_it_works_section_is_visible" boolean DEFAULT true;
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "how_it_works_section_tag" varchar DEFAULT 'HOW IT WORKS';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "how_it_works_section_title" varchar DEFAULT 'Get Started In
  3 Simple Steps';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "how_it_works_section_description" varchar DEFAULT 'Set up your hosting in minutes with our streamlined onboarding process.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "pricing_section_tag" varchar DEFAULT 'PRICING PLANS';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "pricing_section_title" varchar DEFAULT 'Choose The Perfect
  Hosting Plan';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "pricing_section_description" varchar DEFAULT 'Transparent pricing with no hidden fees. Cancel anytime.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "faq_section_tag" varchar DEFAULT 'FAQ';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "faq_section_title" varchar DEFAULT 'Frequently Asked
  Questions';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "faq_section_description" varchar DEFAULT 'Everything you need to know about our AWS hosting services.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "cta_section_badge" varchar DEFAULT 'AWS Powered Hosting';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "cta_section_title" varchar DEFAULT 'Ready To Launch
  On AWS Infrastructure?';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "cta_section_description" varchar DEFAULT 'Get secure, scalable and high-performance hosting backed by AWS cloud technology and expert support.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "cta_section_primary_button_text" varchar DEFAULT 'Get Started';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "cta_section_primary_button_url" varchar DEFAULT '#';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "cta_section_secondary_button_text" varchar DEFAULT 'Contact Sales';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "cta_section_secondary_button_url" varchar DEFAULT '#contact';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "testimonials_section_tag" varchar DEFAULT 'TESTIMONIALS';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "testimonials_section_title" varchar DEFAULT 'What Our Customers
  Are Saying';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "testimonials_section_description" varchar DEFAULT 'Trusted by hundreds of businesses across India and beyond.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "contact_section_tag" varchar DEFAULT 'CONTACT US';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "contact_section_title" varchar DEFAULT 'Let''s Talk About
  Your Hosting Needs';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "contact_section_description" varchar DEFAULT 'Our cloud hosting experts are ready to help you choose the perfect AWS hosting solution.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "contact_section_form_title" varchar DEFAULT 'Request A Callback';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_eyebrow" varchar DEFAULT 'About Hitayu';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_title_line1" varchar DEFAULT 'Reimagine, Digitize &';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_title_highlight" varchar DEFAULT 'Realize Better';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_description" varchar DEFAULT 'Hitayu is a technology solutions company dedicated to helping businesses grow through secure, scalable, and innovative cloud services. We specialize in delivering modern digital solutions that enhance agility, streamline operations, and support long-term business success. Our experience in supporting organizations across various sectors allows us to craft solutions that are both innovative and results oriented. By partnering with us, you gain access to a dedicated team of skilled professionals committed to bringing your ideas to life with precision and expertise. We take pride in our commitment to quality and customer satisfaction. Every solution we design, develop or deliver is thoroughly tested and refined to meet the highest standards before delivery—ensuring dependable performance and outstanding results for our customers.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_image_url" varchar DEFAULT 'https://demo.web-glaze.com/108/wp-content/uploads/2026/06/new-header.png';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_image_id" integer;
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_badge1_title" varchar DEFAULT 'Award Winning';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_badge1_sub" varchar DEFAULT 'Best IT Partner 2024';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_badge2_title" varchar DEFAULT 'ISO 27001';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_badge2_sub" varchar DEFAULT 'Security Certified';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_cta_text" varchar DEFAULT 'Partner with Us';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_cta_url" varchar DEFAULT '#contact';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_agility_title" varchar DEFAULT 'Enabling Agility, Empowering Growth';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_agility_description" varchar DEFAULT 'In a world defined by constant change, the ability to adapt is no longer a competitive advantage—it is a necessity. "Enabling agility, Empowering Growth" captures the essence of what it takes for individuals and organizations to thrive in today''s dynamic environment. Agility is more than speed; it is the capacity to anticipate, respond, and evolve with purpose. We empower organizations by delivering advanced cloud solutions designed to enhance agility across every layer of the enterprise. Through modern architectures such as multi-cloud and hybrid cloud environments, containerization, and microservices, we help businesses modernize their infrastructure and streamline application development. This approach enables faster deployment cycles, improved system reliability, and the flexibility to scale resources dynamically in response to market demands. By enabling agility, we provide organizations with the tools and capabilities to pivot, innovate, and compete effectively. By empowering growth, we create a foundation for sustainable success—where technology not only supports business objectives but drives them forward.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_mvv_eyebrow" varchar DEFAULT 'Our Foundation';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_mvv_title_line1" varchar DEFAULT 'Mission, Vision &';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_mvv_title_highlight" varchar DEFAULT 'Values';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_mission" varchar DEFAULT 'To empower businesses with secure, scalable, and innovative cloud solutions that drive efficiency, growth, and digital transformation.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_vision" varchar DEFAULT 'To be a globally recognized leader in delivering innovative, secure, and scalable cloud solutions that enable sustainable growth and digital transformation.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "about_page_values" varchar DEFAULT 'We conduct our business with honesty, transparency, and strong ethical principles in all interactions. We prioritize our clients'' needs by delivering reliable, high-quality cloud solutions that support their long-term success. We strive for the highest standards in performance, quality, and service delivery in everything we do.';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "contact_home_page_page_eyebrow" varchar DEFAULT 'Get In Touch';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "contact_home_page_page_title" varchar DEFAULT 'Contact Us';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "contact_home_page_offices_eyebrow" varchar DEFAULT 'Our Offices';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "contact_home_page_offices_title" varchar DEFAULT 'All Locations';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "contact_home_page_business_hours" varchar DEFAULT 'Mon–Fri: 9 AM – 6 PM IST';
  ALTER TABLE "site_settings" ADD COLUMN IF NOT EXISTS "contact_home_page_emergency_support" varchar DEFAULT '24 × 7 × 365';
...
EXCEPTION WHEN duplicate_object THEN null;
END $$;;
  CREATE INDEX IF NOT EXISTS "hero_slides_image_idx" ON "hero_slides" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "site_settings_header_info_social_links_order_idx" ON "site_settings_header_info_social_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "site_settings_header_info_social_links_parent_id_idx" ON "site_settings_header_info_social_links" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "site_settings_hero_section_stats_order_idx" ON "site_settings_hero_section_stats" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "site_settings_hero_section_stats_parent_id_idx" ON "site_settings_hero_section_stats" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "site_settings_why_choose_section_features_order_idx" ON "site_settings_why_choose_section_features" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "site_settings_why_choose_section_features_parent_id_idx" ON "site_settings_why_choose_section_features" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "site_settings_aws_section_features_order_idx" ON "site_settings_aws_section_features" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "site_settings_aws_section_features_parent_id_idx" ON "site_settings_aws_section_features" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "site_settings_about_page_features_order_idx" ON "site_settings_about_page_features" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "site_settings_about_page_features_parent_id_idx" ON "site_settings_about_page_features" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "site_settings_contact_home_page_locations_order_idx" ON "site_settings_contact_home_page_locations" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "site_settings_contact_home_page_locations_parent_id_idx" ON "site_settings_contact_home_page_locations" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "site_settings_contact_home_page_locations_image_idx" ON "site_settings_contact_home_page_locations" USING btree ("image_id");
...
EXCEPTION WHEN duplicate_object THEN null;
END $$;;
  CREATE INDEX IF NOT EXISTS "services_service_image_idx" ON "services" USING btree ("service_image_id");
  CREATE INDEX IF NOT EXISTS "site_settings_logo_idx" ON "site_settings" USING btree ("logo_id");
  CREATE INDEX IF NOT EXISTS "site_settings_hero_section_hero_section_hero_image_idx" ON "site_settings" USING btree ("hero_section_hero_image_id");
  CREATE INDEX IF NOT EXISTS "site_settings_aws_section_aws_section_section_image_idx" ON "site_settings" USING btree ("aws_section_section_image_id");
  CREATE INDEX IF NOT EXISTS "site_settings_about_page_about_page_image_idx" ON "site_settings" USING btree ("about_page_image_id");
